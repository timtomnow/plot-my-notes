  ...
  return (
    <div className="fixed inset-0 z-40 flex items-end justify-center md:items-center">
      ...
      <div
        ...
        aria-modal="true"
        aria-label={title}
        className="relative z-10 flex max-h-[90dvh] w-full max-w-md flex-col rounded-t-3xl bg-white shadow-sheet dark:bg-ink-900 md:max-h-[85dvh] md:rounded-2xl"
      >
        ...
        <div
          ...
          style={footer ? undefined : { paddingBottom: 'calc(1rem + var(--safe-bottom))' }}
        >
          {children}
        </div>
        {footer && (
          <div
            className="flex shrink-0 items-center justify-end gap-2 border-t border-ink-100 px-5 py-3 dark:border-ink-800"
